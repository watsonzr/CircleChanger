...
class CircleChanger(object):
    ...
    def swallow(self, other_circle_changer):
        ...
        new_center_point = other_circle_changer.circle.center.halfway_to(self.circle.center)
        ...
        return CircleChanger(new_center_point.x, new_center_point.y, new_radius, 'red', new_colors)
    ...
    def change_to_next_color_in_tuple(self):
        ...
        self.circle.fill_color = self.colors[self.color_changer]
        self.color_changer = self.color_changer + 1
        if self.color_changer >= len(self.colors):
            self.color_changer = 0
